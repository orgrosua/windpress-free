...
class Main implements IntegrationInterface
{
    ...
    {
        $providers[] = ['id' => $this->get_name(), 'name' => 'Elementor', 'description' => 'Elementor integration', 'callback' => \WindPress\WindPress\Integration\Elementor\Compile::class, 'enabled' => $this->is_enabled()];
        return $providers;
    }
