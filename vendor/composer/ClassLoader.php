 ...
 */
namespace WindPressPackages\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function getPrefixes()
    {
        if (!empty($this->prefixesPsr0)) {
            return \call_user_func_array('WindPressPackages\\array_merge', \array_values($this->prefixesPsr0));
        }
        return array();
    }
    /**
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('WindPressPackages\\HHVM_VERSION')) {
